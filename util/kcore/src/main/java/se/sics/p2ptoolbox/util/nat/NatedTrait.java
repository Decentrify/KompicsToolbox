...
//                (adr.getTrait(NatedTrait.class).type.equals(Nat.Type.OPEN) 
//                || adr.getTrait(NatedTrait.class).type.equals(Nat.Type.UPNP));
//    }
//    
...
//        return new NatedTrait(Nat.Type.OPEN, null, null, 0, null, 0, new ArrayList<DecoratedAddress>());
//    }
//
//    public static NatedTrait firewall() {
//        return new NatedTrait(Nat.Type.FIREWALL, null, null, 0, null, 0, new ArrayList<DecoratedAddress>());
//    }
//
//    public static NatedTrait udpBlocked() {
//        return new NatedTrait(Nat.Type.UDP_BLOCKED, null, null, 0, null, 0, new ArrayList<DecoratedAddress>());
//    }
//
//    public static NatedTrait upnp() {
//        return new NatedTrait(Nat.Type.UPNP, null, null, 0, null, 0, new ArrayList<DecoratedAddress>());
//    }
//    
//    public static NatedTrait nated(Nat.MappingPolicy mappingPolicy, Nat.AllocationPolicy allocationPolicy, int delta,
//            Nat.FilteringPolicy filteringPolicy, long bindingTimeout, ArrayList<DecoratedAddress> parents) {
//        assert mappingPolicy != null;
//        assert allocationPolicy != null;
//        assert filteringPolicy != null;
//        assert bindingTimeout > 0;
//        return new NatedTrait(Nat.Type.NAT, mappingPolicy, allocationPolicy, delta, filteringPolicy, bindingTimeout, parents);
//    }
//
//    private NatedTrait(Nat.Type type, Nat.MappingPolicy mappingPolicy, Nat.AllocationPolicy allocationPolicy, int delta,
//            Nat.FilteringPolicy filteringPolicy, long bindingTimeout, List<DecoratedAddress> parents) {
//        this.type = type;
