 ...
 */
public class OverlayMsgSelector extends ChannelSelector<KContentMsg, Identifier> {

    public OverlayMsgSelector(Identifier overlayId, boolean positive) {
        super(KContentMsg.class, overlayId, positive);
    }
