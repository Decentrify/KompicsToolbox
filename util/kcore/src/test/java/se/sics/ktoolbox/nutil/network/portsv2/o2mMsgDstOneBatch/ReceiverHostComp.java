 ...
 */
package se.sics.ktoolbox.nutil.network.portsv2.o2mMsgDstOneBatch;
...
public class ReceiverHostComp extends ComponentDefinition {
  ...
  Handler handleStart = new Handler<Start>() {
    ...
    public void handle(Start event) {
      ...
      channelSelectors.put(TestMsgs.MSG1, new MsgIdExtractorsV2.Destination<>());
      OutgoingOne2NMsgChannelV2 channel = OutgoingOne2NMsgChannelV2.getChannel("test-channel", logger,
        driver.getPositive(Network.class), new MsgTypeExtractorsV2.Base(), channelSelectors);
      
      Component receiver1 = create(ReceiverComp.class, new ReceiverComp.Init(init.dst1.getId(), "1"));
      channel.addChannel(init.dst1.getId(), receiver1.getNegative(Network.class));
      Component receiver2 = create(ReceiverComp.class, new ReceiverComp.Init(init.dst2.getId(), "2"));
      channel.addChannel(init.dst2.getId(), receiver2.getNegative(Network.class));
