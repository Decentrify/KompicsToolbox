 ...
 */
package se.sics.ktoolbox.nutil.conn.base.simpleProxyMngr;
...
public class HostComp extends ComponentDefinition {
  ...
  Handler handleStart = new Handler<Start>() {
    ...
    public void handle(Start event) {
      ...
      Component server = create(ConnProxyMngrServerComp.class, new ConnProxyMngrServerComp.Init(init.serverAddress, Optional.empty()));
      ...
      Component client = create(ConnProxyMngrClientComp.class, new ConnProxyMngrClientComp.Init(init.overlayId, 
