 ...
 */
package se.sics.ktoolbox.nutil.network.portsv2.o2mMsgDstTwoBatch;
...
public class ReceiverHostComp extends ComponentDefinition {
  ...
  Handler handleStart = new Handler<Start>() {
    ...
    public void handle(Start event) {
      ...
      Map<String, MsgIdExtractorV2> channelSelectors2 = new HashMap<>();
      channelSelectors2.put(TestMsgs.MSG2, new MsgIdExtractorsV2.Destination<>());
      OutgoingOne2NMsgChannelV2 channel2 = OutgoingOne2NMsgChannelV2.getChannel("test-channel2", logger,
        driver.getPositive(Network.class), new MsgTypeExtractorsV2.Base(), channelSelectors2);
      ...
      channel2.addChannel(init.dst1.getId(), receiver3.getNegative(Network.class));
      Component receiver4 = create(ReceiverComp.class, new ReceiverComp.Init(init.dst2.getId(), "4"));
      channel2.addChannel(init.dst2.getId(), receiver4.getNegative(Network.class));
