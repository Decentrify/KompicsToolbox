 ...
 */
public class LBAOTransferMngr implements TransferMngr {
    ...
    public LBAOTransferMngr(Torrent torrent, HashMngr hashMngr, FileMngr fileMngr, int maxBufferSize) {
    ...
    public void checkCompleteBlocks() {
        ...
        Iterator<Map.Entry<Integer, BlockMngr>> it = queuedBlocks.entrySet().iterator();
        while (it.hasNext()) {
            Map.Entry<Integer, BlockMngr> block = it.next();
            if (block.getKey().equals(writeBlockNr)) {
