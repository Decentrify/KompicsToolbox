...
public class AppMsgSerializer {
    ...
    public static class Ping implements Serializer {
        ...
        @Override
        public AppMsg.Ping fromBinary(ByteBuf buf, Optional<Object> hint) {
            return new AppMsg.Ping();
        }
    }
    ...
    public static class Pong implements Serializer {
        ...
        @Override
        public AppMsg.Pong fromBinary(ByteBuf buf, Optional<Object> hint) {
            return new AppMsg.Pong();
        }
    }
}
