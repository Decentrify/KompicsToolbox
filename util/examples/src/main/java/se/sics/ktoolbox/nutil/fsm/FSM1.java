...
//  }
//
//  public static MultiFSM build(MyExternalState es, FSMInternalStateBuilders isb, OnFSMExceptionAction oexa) throws FSMException {
...
//        .buildEvents();
//      
//    FSMachineDef fsm = FSMBuilder.multiFSM(FSMs.fsm1, machine, handlers, es, isb, oexa);
//    return fsm;
//  }
//
