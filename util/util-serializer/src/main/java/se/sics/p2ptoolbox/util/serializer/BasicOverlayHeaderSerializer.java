...
// */
//public class BasicOverlayHeaderSerializer implements Serializer {
//
//    private final int id;
//
//    public BasicOverlayHeaderSerializer(int id) {
//        this.id = id;
//    }
//
//    @Override
...
//        BasicOverlayHeader obj = (BasicOverlayHeader) o;
//
...
//        Address src = (Address) Serializers.fromBinary(buf, Optional.absent());
//        Address dst = (Address) Serializers.fromBinary(buf, Optional.absent());
//        
