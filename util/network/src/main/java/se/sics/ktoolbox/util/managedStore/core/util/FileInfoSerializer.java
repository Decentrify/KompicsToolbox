...
public class FileInfoSerializer implements Serializer {
    ...
    public FileInfoSerializer(int id) {
        this.id = id;
    }
    ...
    public void toBinary(Object o, ByteBuf buf) {
        ...
        buf.writeLong(obj.size);
    }

    @Override
    public Object fromBinary(ByteBuf buf, Optional<Object> hint) {
        int nameBytesLenght = buf.readInt();
        byte[] nameBytes = new byte[nameBytesLenght];
        buf.readBytes(nameBytes);
        String name = new String(nameBytes);
        long size = buf.readLong();
        
        return FileInfo.newFile(name, size);
    }
