 ...
 */
public class FileInfoSerializerTest {
    @BeforeClass
    ...
    public void testSimple() {
        Serializer serializer = Serializers.lookupSerializer(FileInfo.class);
        FileInfo original, copy;
        ByteBuf serializedOriginal, serializedCopy;

        original = FileInfo.newFile("file1", 1024*1024);
        ...
        copy = (FileInfo) serializer.fromBinary(serializedCopy, Optional.absent());
