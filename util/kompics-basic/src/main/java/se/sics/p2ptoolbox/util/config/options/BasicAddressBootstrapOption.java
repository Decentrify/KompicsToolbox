...
public class BasicAddressBootstrapOption extends Composite<List> {
    ...
    public BasicAddressBootstrapOption(String optName, KConfigLevel optLvl) {
    ...
    public Optional<List> readValue(KConfigCore config) {
        ...
        Basic<List> partnersOpt = new Basic(sPartnersOpt, List.class, lvl);
        ...
        for(String partner : (List<String>)partners.get()) {
            ...
            BasicAddressOption adrOpt = new BasicAddressOption(sAdrOpt, lvl);
