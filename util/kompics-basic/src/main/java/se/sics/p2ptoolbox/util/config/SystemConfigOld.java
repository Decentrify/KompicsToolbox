 ...
 */
public class SystemConfigOld {

    private final static Logger LOG = LoggerFactory.getLogger(SystemConfigOld.class);
    ...
    public SystemConfigOld(Config config) {
        this(config, null);
    }
    
    public SystemConfigOld(Config config, InetAddress ip) {
        this.config = config;
        this.ip = ip;
        readConfig();
    }
    ...
    public SystemConfigOld(long seed, DecoratedAddress self, DecoratedAddress aggregator) {
        this.seed = seed;
        this.self = self;
