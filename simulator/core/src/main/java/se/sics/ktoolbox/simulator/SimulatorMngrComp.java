...
import se.sics.ktoolbox.simulator.SimulatorComp;
...
import se.sics.ktoolbox.simulator.util.SimulationContext;
...
public class SimulatorMngrComp extends ComponentDefinition implements SimulatorComp {
    ...
    public SimulatorMngrComp(SimulatorMngrInit init) {
        ...
        simulationContext = new SimulationContext(SimulationScenario.getRandom());
    ...
    public static class SimulatorMngrInit extends Init<SimulatorMngrComp> {
        ...
        public SimulatorMngrInit(Set<SystemStatusHandler> systemStatusHandlers) {
