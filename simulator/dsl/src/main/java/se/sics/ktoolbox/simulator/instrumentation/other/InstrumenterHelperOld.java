...
//import se.sics.ktoolbox.simulator.instrumentation.BaseEditor;
...
// */
//public class InstrumenterHelperOld {
//    private static Logger LOG = LoggerFactory.getLogger(BaseEditor.class);
//
...
//        }
//        BaseEditor ci = new BaseEditor(allowThreads, CodeInterceptor.DEFAULT_REDIRECT);
//
