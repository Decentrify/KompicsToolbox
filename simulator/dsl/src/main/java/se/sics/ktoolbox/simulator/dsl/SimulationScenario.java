 ...
 */
package se.sics.ktoolbox.simulator.dsl;
...
import se.sics.ktoolbox.simulator.dsl.adaptor.ConcreteOperation;
import se.sics.ktoolbox.simulator.dsl.adaptor.Operation;
import se.sics.ktoolbox.simulator.dsl.adaptor.Operation1;
import se.sics.ktoolbox.simulator.dsl.adaptor.Operation2;
import se.sics.ktoolbox.simulator.dsl.adaptor.Operation3;
import se.sics.ktoolbox.simulator.dsl.adaptor.Operation4;
import se.sics.ktoolbox.simulator.dsl.adaptor.Operation5;
import se.sics.ktoolbox.simulator.dsl.adaptor.OperationGenerator;
import se.sics.ktoolbox.simulator.dsl.distribution.BigIntegerExponentialDistribution;
import se.sics.ktoolbox.simulator.dsl.distribution.BigIntegerNormalDistribution;
import se.sics.ktoolbox.simulator.dsl.distribution.BigIntegerUniformDistribution;
import se.sics.ktoolbox.simulator.dsl.distribution.ConstantDistribution;
import se.sics.ktoolbox.simulator.dsl.distribution.Distribution;
import se.sics.ktoolbox.simulator.dsl.distribution.DoubleExponentialDistribution;
import se.sics.ktoolbox.simulator.dsl.distribution.DoubleNormalDistribution;
import se.sics.ktoolbox.simulator.dsl.distribution.DoubleUniformDistribution;
import se.sics.ktoolbox.simulator.dsl.distribution.LongExponentialDistribution;
import se.sics.ktoolbox.simulator.dsl.distribution.LongNormalDistribution;
import se.sics.ktoolbox.simulator.dsl.distribution.LongUniformDistribution;
import se.sics.ktoolbox.simulator.dsl.events.SimulationTerminatedEvent;
import se.sics.ktoolbox.simulator.dsl.events.SimulatorEvent;
import se.sics.ktoolbox.simulator.dsl.events.StochasticProcessEvent;
import se.sics.ktoolbox.simulator.dsl.events.StochasticProcessStartEvent;
import se.sics.ktoolbox.simulator.dsl.events.StochasticProcessTerminatedEvent;
import se.sics.ktoolbox.simulator.dsl.events.TakeSnapshot;
import se.sics.ktoolbox.simulator.dsl.events.TakeSnapshotEvent;
import se.sics.ktoolbox.simulator.CodeInstrumenter;
import se.sics.ktoolbox.simulator.InstrumenterHelper;
import se.sics.ktoolbox.simulator.TimeInterceptor;
...
public abstract class SimulationScenario implements Serializable {
    ...
    protected final void terminateAt(long time) {
        SimulationTerminatedEvent terminationEvent = new SimulationTerminatedEvent(time, 0, false);
    ...
    public final void simulate(Class<? extends ComponentDefinition> main, boolean allowThreads) {
        simulate(main, new TimeInterceptor(null, allowThreads));
    }

    public final void simulate(Class<? extends ComponentDefinition> main, Translator t) {
        InstrumenterHelper.store(this);
    ...
    public final LinkedList<SimulatorEvent> generateEventList() {
        LinkedList<SimulatorEvent> eventList = new LinkedList<>();
        int started = 0;
