...
public class CodeInstrumenter extends ExprEditor {
    ...
    public CodeInstrumenter(String system, boolean allowThreads) {
    ...
    public CodeInstrumenter(boolean allowThreads) {
        this("se.sics.kompics.simulation.SimulatorSystem", allowThreads);
    }
