 ...
 */
package se.sics.p2ptoolbox.caracalclient.schemasetup.run;
...
import se.sics.p2ptoolbox.caracalclient.schemasetup.CCSchemaSetup;
import se.sics.p2ptoolbox.caracalclient.schemasetup.CCSchemaSetupComp;
...
public class Launcher extends ComponentDefinition {
    ...
    public Launcher() {
        ...
        CCSchemaSetup schemaSetup = new CCSchemaSetup(config);
        host = create(CCSchemaSetupComp.class, new CCSchemaSetupComp.CCSchemaSetupInit(ccConfig, schemaSetup));
