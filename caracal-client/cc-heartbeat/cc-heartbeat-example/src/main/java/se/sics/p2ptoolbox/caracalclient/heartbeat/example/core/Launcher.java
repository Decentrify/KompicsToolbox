 ...
 */
package se.sics.p2ptoolbox.caracalclient.heartbeat.example.core;
...
import se.sics.p2ptoolbox.caracalclient.bootstrap.CCBootstrapComp;
import se.sics.p2ptoolbox.caracalclient.bootstrap.CCBootstrapConfig;
...
import se.sics.p2ptoolbox.caracalclient.heartbeat.CCHeartbeatComp;
import se.sics.p2ptoolbox.caracalclient.heartbeat.CCHeartbeatConfig;
import se.sics.p2ptoolbox.caracalclient.heartbeat.CCHeartbeatPort;
...
public class Launcher extends ComponentDefinition {
    ...
    public Launcher() {
        ...
        ccBootstrap = create(CCBootstrapComp.class, new CCBootstrapComp.CCBootstrapInit(new SystemConfig(config), new CCBootstrapConfig(config), ccConfig.caracalNodes));
        ...
        ccHearbeat = create(CCHeartbeatComp.class, new CCHeartbeatComp.CCHeartbeatInit(new SystemConfig(config), new CCHeartbeatConfig(config)));
