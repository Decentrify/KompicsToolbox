...
//import se.sics.ktoolbox.croupier.TestHelper;
...
//
//        NatAwareAddress simpleAdr1 = DecoratedAddress.open(localHost, 10000, 1);
//        original = new CroupierContainer(simpleAdr1, new TestHelper.TestContent(1));;
