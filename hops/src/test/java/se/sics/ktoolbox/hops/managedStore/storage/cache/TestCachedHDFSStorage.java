...
public class TestCachedHDFSStorage {
    ...
    public void test1() {
        ...
        HDFSResource uploadResource = new HDFSResource("bbc1.sics.se", 26801, "/experiment/upload/", "file");
        Pair<FileMngr, HashMngr> upload = HopsFactory.getCompleteCached(config, uploadResource, "glassfish", hashAlg, blockLength, pieceLength);
        HDFSResource downloadResource = new HDFSResource("bbc1.sics.se", 26801, "/experiment/download/", "file");
        Pair<FileMngr, HashMngr> download = HopsFactory.getIncompleteCached(config, downloadResource, "glassfish", 100 * 1000 * 1000, hashAlg, blockLength, pieceLength);
