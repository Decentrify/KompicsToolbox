...
//    private static BasicAddress basicAddress;
...
//        id = idArg;
//        try {
//            basicAddress = new BasicAddress(InetAddress.getByName(bootstrapIp), port, bootstrapId);
//            aggregatorNodeAddress = new DecoratedAddress(basicAddress);
//
...
//
//        network = create(NettyNetwork.class, new NettyInit(seed, true, ExampleFrameNetDecoder.class));
