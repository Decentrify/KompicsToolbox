 ...
 */
public class ChunkManagerScenarioOperations {
    ...
    static Operation2<StartNodeCmd, Integer, Integer> startNodeOp = new Operation2<StartNodeCmd, Integer, Integer>() {
        ...
        @Override
        public StartNodeCmd generate(final Integer nodeId, final Integer partnerNodeId) {
            return new StartNodeCmd<ExampleHostComp, DecoratedAddress>() {
                private DecoratedAddress nodeAddress;
                private DecoratedAddress partnerNodeAddress;
                ...
                public ExampleHostComp.HostInit getNodeComponentInit(DecoratedAddress aggregatorServer, Set<DecoratedAddress> bootstrapNodes) {
                    ...
                    if (partnerNodeId == 0) {
                        partnerNodeAddress = null;
                    } else {
                        partnerNodeAddress = new DecoratedAddress(new BasicAddress(localHost, 12345, partnerNodeId));
                    }
                    /**
        ...
        public SimulationResult generate() {
            return new SimulationResult() {
                ...
                public void setSimulationResult(OperationCmd.ValidationException failureCause) {
                    ChunkManagerSimulationResult.failureCause = failureCause;
                }
            };
        }
    };
