 ...
 */
package se.sics.p2ptoolbox.chunkmanager.example;
...
import se.sics.p2ptoolbox.chunkmanager.example.simulation.ChunkManagerSimulationResult;
import se.sics.p2ptoolbox.chunkmanager.example.simulation.ChunkManagerSimulationScenarios;
 ...
 */
public class ChunkManagerSimulationTest {
    ...
    private void simpleBoot(int nodes, long seed, int simulatedSeconds) {
        ...
        LauncherComp.scenario = ChunkManagerSimulationScenarios.simpleBoot(nodes, 1234L, simulatedSeconds);
        //
        try {
        ...
        Assert.assertEquals(null, ChunkManagerSimulationResult.failureCause);
    }
}
