...
import se.sics.ktoolbox.tgradient.util.ParentPreferenceComparator;
...
public class GradientPreferenceComparatorTest {
    ...
    public void test1() {
        ...
        Integer[] expectedRanks = new Integer[]{0, 2, 4};

        List<TestGradientContainer> nodeList = new ArrayList<>();
        ...
        for(int i = 0; i < nodeList.size(); i++) {
            ranks[i] = nodeList.get(i).rank;
        }
        Assert.assertTrue(Arrays.equals(expectedRanks, ranks));
    }
    ...
    public void test2() {
        ...
        Integer[] expectedRanks = new Integer[]{2, 0, 4, 6};
    ...
    public void test3() {
        ...
        Integer[] expectedRanks = new Integer[]{3, 5, 8, 2, 0, 9, 11};
