...
public class GradientViewHistoryPacket implements StatePacket {
    ...
    public void append(List<GradientContainer> view) {
    ...
    public String shortPrint() {
        ...
        sb.append("\ngradient view print:");
        for(List<GradientContainer> slice : viewHistory) {
            sb.append("\ngradient view slice:");
            for(GradientContainer neighbour : slice) {
                sb.append(neighbour.getSource().getId()).append("<");
                sb.append("a:").append(neighbour.getAge());
                sb.append(",r:").append(neighbour.rank);
                sb.append(">");
            }
        }
        return sb.toString();
