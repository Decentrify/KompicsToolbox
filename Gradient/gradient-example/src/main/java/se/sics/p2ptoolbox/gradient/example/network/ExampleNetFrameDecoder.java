...
// */
//package se.sics.p2ptoolbox.gradient.example.network;
//
...
//import se.sics.p2ptoolbox.gradient.example.model.CounterView;
//import se.sics.p2ptoolbox.gradient.example.core.PeerViewASerializer;
...
//            context.registerSerializer(CounterView.class, new PeerViewASerializer());
//            context.multiplexAlias(PEER_VIEW_ALIAS, CounterView.class, (byte) 0x01);
