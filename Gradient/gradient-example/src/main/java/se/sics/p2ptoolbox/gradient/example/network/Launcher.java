...
//import se.sics.p2ptoolbox.gradient.example.system.GradientCounterHostComp;
//
///**
...
//        Component hostMngr = create(GradientCounterHostComp.class, new GradientCounterHostComp.HostManagerInit(seed, new VodAddress(selfAddress, -1), bootstrapNode));
