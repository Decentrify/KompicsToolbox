...
public class ChunkSerializer implements Serializer {
    ...
    public void toBinary(Object o, ByteBuf buf) {
        Chunk obj = (Chunk) o;
        Serializers.toBinary(obj.originId, buf);
    ...
    public Object fromBinary(ByteBuf buf, Optional<Object> hint) {
        Identifier originId = (Identifier)Serializers.fromBinary(buf, hint);
        ...
        return new Chunk(originId, chunkNr, lastChunk, content);
    }
}