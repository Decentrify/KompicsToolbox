...
public class IpSolver {
     ...
     */
    public static Optional<InetAddress> getIp(Optional<String> prefferedIp, List<IpSolve.NetworkInterfacesMask> netInterfaces) throws SocketException {
    ...
    public static Set<IpAddressStatus> getLocalNetworkInterfaces(EnumSet<IpSolve.NetworkInterfacesMask> netInterfaces) throws SocketException {
